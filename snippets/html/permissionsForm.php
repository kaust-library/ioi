...
**** This file is responsible of displaying permissions in the page and check the user permissions.
...
echo '
 ...
 echo'
  ...
  {  
    ...
    if(!empty($scope))
    {
      echo 'You have already established the connection between the '.INSTITUTION_ABBREVIATION.' Repository and your ORCID record.<br><br>The permissions you have granted to the '.INSTITUTION_ABBREVIATION.' Repository are checked below. <u>If you make changes to these permissions, please select "Confirm permissions change with ORCID" to complete the update.</u>';
    }
    else
    {   
...
// ---------------------------------------------------------------------------------------------------------------
		...
		echo '
			...
			<form method="post" action="'.$_SERVER['REQUEST_URI'].'">
				...
				<button type="submit" value="submit" id="connect-orcid-button"><img id="orcid-id-icon" src="https://orcid.org/sites/default/files/images/orcid_24x24.png" width="24" height="24" alt="ORCID iD icon"/>Review publications and affiliations transferred to your ORCID record</button>
			</form> 
